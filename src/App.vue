	...
	<div class="container-fluid p-0 m-0 vh-100">
		<div class="row p-0 m-0 h-100">
			<div class="col-12 col-md-5 col-lg-4 bg-light p-0 h-100">
				...
				<button type="button" class="btn btn-dark w-100 py-2 rounded-0" v-on:click="showAddNoteFrom()">
			...
			<div class="col-12 col-md-7 col-lg-8 bg-white p-0">
				...
				<add-note-form v-if="currentNote == null" v-on:onAddNote="addNote($event)"></add-note-form>
...
<script>
	...
	export default {
	components: {AddNoteForm, NotesList, Note},
	data: function (){
	return {
	notes: [],
	currentNote: null,
